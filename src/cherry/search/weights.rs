...
weights! {
    ...
    rfp_depth     | RFP_DEPTH:     i32 => 3072,
    rfp_base      | RFP_BASE:      i32 => 0,
    rfp_scale     | RFP_SCALE:     i32 => 80,
    rfp_lerp      | RFP_LERP:      i32 => 512,
    rfp_imp_depth | RFP_IMP_DEPTH: i32 => 3072,
    rfp_imp_base  | RFP_IMP_BASE:  i32 => -80,
    rfp_imp_scale | RFP_IMP_SCALE: i32 => 80,
    rfp_imp_lerp  | RFP_IMP_LERP:  i32 => 512,

    nmp_depth     | NMP_DEPTH:     i32 => 1536,
    nmp_base      | NMP_BASE:      i64 => 1536,
    nmp_scale     | NMP_SCALE:     i64 => 170,
    nmp_imp_depth | NMP_IMP_DEPTH: i32 => 1536,
    nmp_imp_base  | NMP_IMP_BASE:  i64 => 1536,
    nmp_imp_scale | NMP_IMP_SCALE: i64 => 170,
