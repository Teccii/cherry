...
weights! {
    pawn_corr    | PAWN_CORR:    i32 => 71  | 32..=96;
    minor_corr   | MINOR_CORR:   i32 => 57  | 32..=96;
    major_corr   | MAJOR_CORR:   i32 => 65  | 32..=96;
    nonpawn_corr | NONPAWN_CORR: i32 => 68  | 32..=96;
    cont1_corr   | CONT1_CORR:   i32 => 54  | 32..=96;
    cont2_corr   | CONT2_CORR:   i32 => 56  | 32..=96;
    corr_bonus   | CORR_BONUS:   i64 => 131 | 96..=192;

    quiet_bonus_base   | QUIET_BONUS_BASE:   i64 => 133  | 64..=256;
    quiet_bonus_scale1 | QUIET_BONUS_SCALE1: i64 => 123  | 64..=256;
    quiet_bonus_scale2 | QUIET_BONUS_SCALE2: i64 => 8    | 0..=128;
    quiet_bonus_max    | QUIET_BONUS_MAX:    i64 => 1749 | 1024..=4096;
    quiet_malus_base   | QUIET_MALUS_BASE:   i64 => 99   | 64..=256;
    quiet_malus_scale1 | QUIET_MALUS_SCALE1: i64 => 138  | 64..=256;
    quiet_malus_scale2 | QUIET_MALUS_SCALE2: i64 => 9    | 0..=128;
    quiet_malus_max    | QUIET_MALUS_MAX:    i64 => 1867 | 1024..=4096;

    noisy_bonus_base   | NOISY_BONUS_BASE:   i64 => 121  | 64..=256;
    noisy_bonus_scale1 | NOISY_BONUS_SCALE1: i64 => 119  | 64..=256;
    noisy_bonus_scale2 | NOISY_BONUS_SCALE2: i64 => 12   | 0..=128;
    noisy_bonus_max    | NOISY_BONUS_MAX:    i64 => 2067 | 1024..=4096;
    noisy_malus_base   | NOISY_MALUS_BASE:   i64 => 122  | 64..=256;
    noisy_malus_scale1 | NOISY_MALUS_SCALE1: i64 => 119  | 64..=256;
    noisy_malus_scale2 | NOISY_MALUS_SCALE2: i64 => 12   | 0..=128;
    noisy_malus_max    | NOISY_MALUS_MAX:    i64 => 2032 | 1024..=4096;

    pawn_bonus_base   | PAWN_BONUS_BASE:   i64 => 132  | 64..=256;
    pawn_bonus_scale1 | PAWN_BONUS_SCALE1: i64 => 121  | 64..=256;
    pawn_bonus_scale2 | PAWN_BONUS_SCALE2: i64 => 0    | 0..=128;
    pawn_bonus_max    | PAWN_BONUS_MAX:    i64 => 2286 | 1024..=4096;
    pawn_malus_base   | PAWN_MALUS_BASE:   i64 => 159  | 64..=256;
    pawn_malus_scale1 | PAWN_MALUS_SCALE1: i64 => 112  | 64..=256;
    pawn_malus_scale2 | PAWN_MALUS_SCALE2: i64 => 4    | 0..=128;
    pawn_malus_max    | PAWN_MALUS_MAX:    i64 => 1843 | 1024..=4096;

    cont1_bonus_base   | CONT1_BONUS_BASE:   i64 => 124  | 64..=256;
    cont1_bonus_scale1 | CONT1_BONUS_SCALE1: i64 => 129  | 64..=256;
    cont1_bonus_scale2 | CONT1_BONUS_SCALE2: i64 => 4    | 0..=128;
    cont1_bonus_max    | CONT1_BONUS_MAX:    i64 => 1556 | 1024..=4096;
    cont1_malus_base   | CONT1_MALUS_BASE:   i64 => 114  | 64..=256;
    cont1_malus_scale1 | CONT1_MALUS_SCALE1: i64 => 137  | 64..=256;
    cont1_malus_scale2 | CONT1_MALUS_SCALE2: i64 => 13   | 0..=128;
    cont1_malus_max    | CONT1_MALUS_MAX:    i64 => 2028 | 1024..=4096;

    cont2_bonus_base   | CONT2_BONUS_BASE:   i64 => 119  | 64..=256;
    cont2_bonus_scale1 | CONT2_BONUS_SCALE1: i64 => 119  | 64..=256;
    cont2_bonus_scale2 | CONT2_BONUS_SCALE2: i64 => 7    | 0..=128;
    cont2_bonus_max    | CONT2_BONUS_MAX:    i64 => 1748 | 1024..=4096;
    cont2_malus_base   | CONT2_MALUS_BASE:   i64 => 127  | 64..=256;
    cont2_malus_scale1 | CONT2_MALUS_SCALE1: i64 => 154  | 64..=256;
    cont2_malus_scale2 | CONT2_MALUS_SCALE2: i64 => 5    | 0..=128;
    cont2_malus_max    | CONT2_MALUS_MAX:    i64 => 2279 | 1024..=4096;

    cont4_bonus_base   | CONT4_BONUS_BASE:   i64 => 136  | 64..=256;
    cont4_bonus_scale1 | CONT4_BONUS_SCALE1: i64 => 109  | 64..=256;
    cont4_bonus_scale2 | CONT4_BONUS_SCALE2: i64 => 2    | 0..=128;
    cont4_bonus_max    | CONT4_BONUS_MAX:    i64 => 1900 | 1024..=4096;
    cont4_malus_base   | CONT4_MALUS_BASE:   i64 => 138  | 64..=256;
    cont4_malus_scale1 | CONT4_MALUS_SCALE1: i64 => 139  | 64..=256;
    cont4_malus_scale2 | CONT4_MALUS_SCALE2: i64 => 6    | 0..=128;
    cont4_malus_max    | CONT4_MALUS_MAX:    i64 => 2185 | 1024..=4096;

    pawn_see_value   | PAWN_SEE_VALUE:   i32 => 98  | 50..=150;
    knight_see_value | KNIGHT_SEE_VALUE: i32 => 329 | 150..=400;
    bishop_see_value | BISHOP_SEE_VALUE: i32 => 322 | 150..=400;
    rook_see_value   | ROOK_SEE_VALUE:   i32 => 599 | 400..=700;
    queen_see_value  | QUEEN_SEE_VALUE:  i32 => 982 | 700..=1100;

    mat_scale_pawn   | MAT_SCALE_PAWN:   i32 => 120   | 50..=150;
    mat_scale_knight | MAT_SCALE_KNIGHT: i32 => 372   | 150..=400;
    mat_scale_bishop | MAT_SCALE_BISHOP: i32 => 346   | 150..=400;
    mat_scale_rook   | MAT_SCALE_ROOK:   i32 => 569   | 400..=700;
    mat_scale_queen  | MAT_SCALE_QUEEN:  i32 => 983   | 700..=1100;
    mat_scale_base   | MAT_SCALE_BASE:   i32 => 25155 | 24000..=26000;

    hindsight_ext_eval | HINDSIGHT_EXT_EVAL: i32 => 0    | -100..=0;
    ...
    rfp_scale2     | RFP_SCALE2:     i64 => 763  | 384..=1280;
    rfp_imp_base   | RFP_IMP_BASE:   i64 => -34  | -100..=100;
    rfp_imp_scale1 | RFP_IMP_SCALE1: i64 => 43   | 0..=200;
    rfp_imp_scale2 | RFP_IMP_SCALE2: i64 => 767  | 384..=1280;
    rfp_lerp       | RFP_LERP:       i32 => 551  | 256..=768;

    razor_base       | RAZOR_BASE:       i64 => 344 | 150..=400;
    razor_scale1     | RAZOR_SCALE1:     i64 => 1   | 0..=200;
    razor_scale2     | RAZOR_SCALE2:     i64 => 251 | 150..=400;
    razor_imp_base   | RAZOR_IMP_BASE:   i64 => 345 | 150..=400;
    razor_imp_scale1 | RAZOR_IMP_SCALE1: i64 => 12  | 0..=200;
    razor_imp_scale2 | RAZOR_IMP_SCALE2: i64 => 236 | 150..=400;

    nmp_depth           | NMP_DEPTH:           i32 => 3068  | 2048..=4096;
    nmp_beta_base       | NMP_BETA_BASE:       i64 => 196   | 100..=500;
    nmp_beta_scale1     | NMP_BETA_SCALE1:     i64 => 1923  | 1280..=2560;
    nmp_beta_scale2     | NMP_BETA_SCALE2:     i64 => 9     | 0..=512;
    nmp_imp_beta_base   | NMP_IMP_BETA_BASE:   i64 => 195   | 100..=500;
    nmp_imp_beta_scale1 | NMP_IMP_BETA_SCALE1: i64 => 1918  | 1280..=2560;
    nmp_imp_beta_scale2 | NMP_IMP_BETA_SCALE2: i64 => 13    | 0..=512;
    nmp_base            | NMP_BASE:            i64 => 6004  | 4096..=8192;
    nmp_scale1          | NMP_SCALE1:          i64 => 188   | 0..=512;
    nmp_scale2          | NMP_SCALE2:          i64 => 1     | 0..=256;
    nmp_verif_depth     | NMP_VERIF_DEPTH:     i32 => 14633 | 12288..=16384;

    lmp_base       | LMP_BASE:       i64 => 2136 | 1024..=3072;
    lmp_scale1     | LMP_SCALE1:     i64 => 1    | 0..=512;
    lmp_scale2     | LMP_SCALE2:     i64 => 474  | 256..=768;
    lmp_imp_base   | LMP_IMP_BASE:   i64 => 4218 | 3072..=5120;
    lmp_imp_scale1 | LMP_IMP_SCALE1: i64 => 4    | 0..=512;
    lmp_imp_scale2 | LMP_IMP_SCALE2: i64 => 1056 | 512..=1536;

    fp_depth      | FP_DEPTH:      i32 => 8467 | 6144..=10240;
    fp_base       | FP_BASE:       i64 => 94   | 0..=200;
    fp_scale1     | FP_SCALE1:     i64 => 89   | 0..=200;
    fp_scale2     | FP_SCALE2:     i64 => 22   | 0..=1280;
    fp_imp_base   | FP_IMP_BASE:   i64 => 84   | 0..=200;
    fp_imp_scale1 | FP_IMP_SCALE1: i64 => 95   | 0..=200;
    fp_imp_scale2 | FP_IMP_SCALE2: i64 => 92   | 0..=1280;
    fp_hist_scale | FP_HIST_SCALE: i64 => 267  | 0..=512;

    hp_quiet_depth  | HP_QUIET_DEPTH:  i32 => 5818  | 4096..=8192;
    hp_quiet_base   | HP_QUIET_BASE:   i64 => -73   | -1000..=0;
    hp_quiet_scale1 | HP_QUIET_SCALE1: i64 => -1756 | -5000..=-1000;
    hp_quiet_scale2 | HP_QUIET_SCALE2: i64 => -2    | -500..=0;

    see_quiet_depth  | SEE_QUIET_DEPTH:  i32 => 10184 | 8192..=12288;
    see_quiet_base   | SEE_QUIET_BASE:   i64 => -9    | -200..=0;
    see_quiet_scale1 | SEE_QUIET_SCALE1: i64 => -71   | -200..=0;
    see_quiet_scale2 | SEE_QUIET_SCALE2: i64 => -3    | -100..=0;

    see_noisy_depth      | SEE_NOISY_DEPTH:      i32 => 10296 | 8192..=12288;
    see_noisy_base       | SEE_NOISY_BASE:       i64 => -6    | -200..=0;
    ...
    se_beta_ext          | SE_BETA_EXT:          i32 => -2048 | -2560..=-1536;
    se_cut_ext           | SE_CUT_EXT:           i32 => -2048 | -2560..=-1536;

    lmr_quiet_base | LMR_QUIET_BASE: i32 => 706  | 256..=768;
    lmr_quiet_div  | LMR_QUIET_DIV:  i32 => 1620 | 1024..=2048;
    lmr_noisy_base | LMR_NOISY_BASE: i32 => 490  | 256..=768;
    lmr_noisy_div  | LMR_NOISY_DIV:  i32 => 3691 | 3072..=4096;
    ...
    mp_see_margin    | MP_SEE_MARGIN:    i32 => -37 | -200..=100;
    mp_qs_see_margin | MP_QS_SEE_MARGIN: i32 => -24 | -200..=100;

    qfp_margin | QFP_MARGIN: i32 => 133 | 50..=300;

    asp_window_initial | ASP_WINDOW_INITIAL: i32 => 15 | 10..=40;
    asp_window_expand  | ASP_WINDOW_EXPAND:  i32 => 65 | 48..=96;

    soft_time_div         | SOFT_TIME_DIV:         u64 => 250321 | 196608..=294912;
    soft_time_inc         | SOFT_TIME_INC:         u64 => 4045   | 2048..=4096;
    hard_time_div         | HARD_TIME_DIV:         u64 => 11913  | 8192..=16384;
    hard_time_inc         | HARD_TIME_INC:         u64 => 3892   | 2048..=4096;
    subtree_base          | SUBTREE_BASE:          i64 => 9973   | 8192..=12288;
    subtree_scale         | SUBTREE_SCALE:         i64 => 6571   | 4096..=8192;
    subtree_min           | SUBTREE_MIN:           i64 => 4063   | 2048..=4096;
    move_stability_base   | MOVE_STABILITY_BASE:   i64 => 7392   | 6144..=9216;
    move_stability_scale  | MOVE_STABILITY_SCALE:  i64 => 449    | 256..=768;
    move_stability_min    | MOVE_STABILITY_MIN:    i64 => 3469   | 2048..=4096;
    score_stability_edge  | SCORE_STABILITY_EDGE:  i32 => 19     | 10..=40;
    score_stability_base  | SCORE_STABILITY_BASE:  i64 => 7626   | 6144..=9216;
    score_stability_scale | SCORE_STABILITY_SCALE: i64 => 360    | 256..=768;
    score_stability_min   | SCORE_STABILITY_MIN:   i64 => 3871   | 2048..=4096;
}
