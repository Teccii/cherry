...
const LOG: [f32; MAX_PLY as usize] = [
...
weights! {
    ...
    move_stability_base  | MOVE_STABILITY_BASE:  u64 => 7373,
    move_stability_scale | MOVE_STABILITY_SCALE: u64 => 410,
    move_stability_min   | MOVE_STABILITY_MIN:   u64 => 3686,
    eval_stability_edge  | EVAL_STABILITY_EDGE:  i32 => 20,
    eval_stability_base  | EVAL_STABILITY_BASE:  u64 => 7373,
    eval_stability_scale | EVAL_STABILITY_SCALE: u64 => 410,
    eval_stability_min   | EVAL_STABILITY_MIN:   u64 => 3686,
    complexity_base      | COMPLEXITY_BASE:      u64 => 3277,
    complexity_scale     | COMPLEXITY_SCALE:     u64 => 82,
    complexity_max       | COMPLEXITY_MAX:       u64 => 6144,
}
