...
weights! {
    ...
    se_dext_margin  | SE_DEXT_MARGIN:  i32 => 30   | 0..=40;
    se_text_margin  | SE_TEXT_MARGIN:  i32 => 67   | 40..=80;
    se_ext          | SE_EXT:          i32 => 1024 | 512..=1536;
    se_dext         | SE_DEXT:         i32 => 2048 | 1536..=2560;
    se_text         | SE_TEXT:         i32 => 3072 | 2560..=3584;
