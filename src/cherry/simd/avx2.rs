...
impl Vec128 {
    ...
    #[inline]
    pub fn compress8(mut mask: Vec128Mask8, vec: Vec128) -> Vec128 {
    ...
    #[inline]
    pub fn compress16(mut mask: Vec128Mask16, vec: Vec128) -> Vec128 {
    ...
    #[inline]
    pub fn compress32(mut mask: Vec128Mask32, vec: Vec128) -> Vec128 {
        let mut values = [0u32; Self::CHUNKS_32];
        unsafe { Vec128::store(values.as_mut_ptr(), vec); }

        let mut temp = [0u32; Self::CHUNKS_32];
        let mut cursor = 0;
    ...
    #[inline]
    pub fn compress64(mut mask: Vec128Mask64, vec: Vec128) -> Vec128 {
    ...
    #[inline]
    pub fn compress_store8<T>(dest: *mut T, mut mask: Vec128Mask8, vec: Vec128) {
        let mut values = [0u8; Self::CHUNKS_8];
        unsafe { Vec128::store(values.as_mut_ptr(), vec); }
        ...
        unsafe { ptr::copy_nonoverlapping(temp.as_ptr(), dest.cast(), cursor); }
    }
    ...
    #[inline]
    pub fn compress_store32<T>(dest: *mut T, mut mask: Vec128Mask32, vec: Vec128) {
        let mut values = [0u32; Self::CHUNKS_32];
        unsafe { Vec128::store(values.as_mut_ptr(), vec); }
        ...
        unsafe { ptr::copy_nonoverlapping(temp.as_ptr().cast::<i8>(), dest.cast(), cursor * size_of::<u32>()); }
    }

    #[inline]
    pub fn compress_store64<T>(dest: *mut T, mut mask: Vec128Mask64, vec: Vec128) {
        let mut values = [0u64; Self::CHUNKS_64];
        unsafe { Vec128::store(values.as_mut_ptr(), vec); }
    ...
    pub fn zero8(self) -> Vec128Mask8 {
        Vec128::eq8(self, Vec128::zero())
    }

    #[inline]
    pub fn zero16(self) -> Vec128Mask16 {
        Vec128::eq16(self, Vec128::zero())
    }
    ...
    pub fn eq16(a: Vec128, b: Vec128) -> Vec128Mask16 {
        unsafe { _pext_u32(_mm_movemask_epi8(_mm_cmpeq_epi16(a.raw, b.raw)) as u32, 0xAAAA) as Vec128Mask16 }
    }

    #[inline]
    pub fn eq32(a: Vec128, b: Vec128) -> Vec128Mask32 {
        unsafe { _pext_u32(_mm_movemask_epi8(_mm_cmpeq_epi32(a.raw, b.raw)) as u32, 0x8888) as Vec128Mask32 }
    }

    #[inline]
    pub fn eq64(a: Vec128, b: Vec128) -> Vec128Mask64 {
        unsafe { _pext_u32(_mm_movemask_epi8(_mm_cmpeq_epi32(a.raw, b.raw)) as u32, 0x8080) as Vec128Mask64 }
    }
    ...
    #[inline]
    pub fn neq32(a: Vec128, b: Vec128) -> Vec128Mask32 {
        unsafe { _pext_u32(!_mm_movemask_epi8(_mm_cmpeq_epi32(a.raw, b.raw)) as u32, 0x8888) as Vec128Mask32 }
    }

    #[inline]
    pub fn neq64(a: Vec128, b: Vec128) -> Vec128Mask64 {
        unsafe { _pext_u32(!_mm_movemask_epi8(_mm_cmpeq_epi32(a.raw, b.raw)) as u32, 0x8080) as Vec128Mask64 }
    }
    ...
    pub fn test16(a: Vec128, b: Vec128) -> Vec128Mask16 {
        Vec128::eq16(a & b, Vec128::zero())
    }

    #[inline]
    pub fn test32(a: Vec128, b: Vec128) -> Vec128Mask32 {
        Vec128::eq32(a & b, Vec128::zero())
    }

    #[inline]
    pub fn test64(a: Vec128, b: Vec128) -> Vec128Mask64 {
        Vec128::eq64(a & b, Vec128::zero())
    }
    ...
    pub fn testn8(a: Vec128, b: Vec128) -> Vec128Mask8 {
        Vec128::neq8(a & b, Vec128::zero())
    }

    #[inline]
    pub fn testn16(a: Vec128, b: Vec128) -> Vec128Mask16 {
        Vec128::neq16(a & b, Vec128::zero())
    }

    #[inline]
    pub fn testn32(a: Vec128, b: Vec128) -> Vec128Mask32 {
        Vec128::neq32(a & b, Vec128::zero())
    }

    #[inline]
    pub fn testn64(a: Vec128, b: Vec128) -> Vec128Mask64 {
        Vec128::neq64(a & b, Vec128::zero())
    }
    ...
    #[inline]
    pub fn expand_mask32(mut mask: Vec128Mask32) -> Vec128 {
        let mut temp = [0u32; Self::CHUNKS_32];

        while mask != 0 {
            temp[mask.trailing_zeros() as usize] = u32::MAX;
            mask &= mask.wrapping_sub(1);
        }
    ...
    #[inline]
    pub fn expand_mask64(mut mask: Vec128Mask64) -> Vec128 {
        let mut temp = [0u64; Self::CHUNKS_64];

        while mask != 0 {
            temp[mask.trailing_zeros() as usize] = u64::MAX;
            mask &= mask.wrapping_sub(1);
        }
...
impl Vec256 {
    ...
    pub fn mask8(mask: Vec256Mask8, vec: Vec256) -> Vec256 {
        vec & Vec256::expand_mask8(mask)
    }

    #[inline]
    pub fn mask16(mask: Vec256Mask16, vec: Vec256) -> Vec256 {
        vec & Vec256::expand_mask16(mask)
    }
    ...
    #[inline]
    pub fn compress8(mut mask: Vec256Mask8, vec: Vec256) -> Vec256 {
        let mut values = [0u8; Self::CHUNKS_8];
    ...
    #[inline]
    pub fn compress16(mut mask: Vec256Mask16, vec: Vec256) -> Vec256 {
        let mut values = [0u16; Self::CHUNKS_16];
        unsafe { Vec256::store(values.as_mut_ptr(), vec); }
    ...
    #[inline]
    pub fn compress32(mut mask: Vec256Mask32, vec: Vec256) -> Vec256 {
        let mut values = [0u32; Self::CHUNKS_32];
        unsafe { Vec256::store(values.as_mut_ptr(), vec); }
    ...
    #[inline]
    pub fn compress64(mut mask: Vec256Mask64, vec: Vec256) -> Vec256 {
        let mut values = [0u64; Self::CHUNKS_64];
        unsafe { Vec256::store(values.as_mut_ptr(), vec); }
    ...
    #[inline]
    pub fn compress_store8<T>(dest: *mut T, mut mask: Vec256Mask8, vec: Vec256) {
        let mut values = [0u8; Self::CHUNKS_8];
        unsafe { Vec256::store(values.as_mut_ptr(), vec); }
    ...
    #[inline]
    pub fn compress_store32<T>(dest: *mut T, mut mask: Vec256Mask32, vec: Vec256) {
        let mut values = [0u32; Self::CHUNKS_32];
        unsafe { Vec256::store(values.as_mut_ptr(), vec); }
    ...
    #[inline]
    pub fn compress_store64<T>(dest: *mut T, mut mask: Vec256Mask64, vec: Vec256) {
        let mut values = [0u64; Self::CHUNKS_64];
        unsafe { Vec256::store(values.as_mut_ptr(), vec); }
    ...
    pub fn bitshuffle(a: Vec256, b: Vec256) -> Vec256Mask8 {
        #[inline]
        fn shl8(a: Vec256, b: Vec256) -> Vec256 {
            let b = Vec256::shl16::<5>(b);
            let shl = Vec256::splat8(0xf0u8) & Vec256::shl16::<4>(a);
            let a = Vec256::blend8(b, a, shl);

            let b = Vec256::add8(b, b);
            let shl = Vec256::splat8(0xfcu8) & Vec256::shl16::<2>(a);
            let a = Vec256::blend8(b, a, shl);

            let b = Vec256::add8(b, b);
            let shl = Vec256::splat8(0xfeu8) & Vec256::shl16::<1>(a);
            let a = Vec256::blend8(b, a, shl);

            a
        }

        let idx = b & Vec256::splat8(0x3f);
        let byte_idx = Vec256::add64(
            Vec256::shr16::<3>(idx) & Vec256::splat8(7),
            unsafe { _mm256_setr_epi64x(0, 0x0808080808080808, 0, 0x0808080808080808).into() }
        );
        let shuffled = Vec256::shuffle8(a, byte_idx);
        let shift = Vec256::splat8(7) ^ (idx & Vec256::splat8(7));
    ...
    pub fn lane_splat8to64(vec: Vec256) -> Vec256 {
        unsafe {
            let vec = _mm256_sad_epu8(vec.raw, Vec256::zero().raw);
            let expand_idx = _mm256_setr_epi8(
            ...
            _mm256_shuffle_epi8(vec, expand_idx).into()
        }
    }
    ...
    pub fn eq16(a: Vec256, b: Vec256) -> Vec256Mask16 {
        unsafe { _pext_u32(_mm256_movemask_epi8(_mm256_cmpeq_epi16(a.raw, b.raw)) as Vec256Mask8, 0xAAAAAAAA) as Vec256Mask16 }
    }

    #[inline]
    pub fn eq32(a: Vec256, b: Vec256) -> Vec256Mask32 {
        unsafe { _pext_u32(_mm256_movemask_epi8(_mm256_cmpeq_epi32(a.raw, b.raw)) as Vec256Mask8, 0x88888888) as Vec256Mask32 }
    }

    #[inline]
    pub fn eq64(a: Vec256, b: Vec256) -> Vec256Mask64 {
        unsafe { _pext_u32(_mm256_movemask_epi8(_mm256_cmpeq_epi64(a.raw, b.raw)) as Vec256Mask8, 0x80808080) as Vec256Mask64 }
    }
    ...
    #[inline]
    pub fn neq32(a: Vec256, b: Vec256) -> Vec256Mask32 {
        unsafe { _pext_u32(!_mm256_movemask_epi8(_mm256_cmpeq_epi32(a.raw, b.raw)) as Vec256Mask8, 0x88888888) as Vec256Mask32 }
    }

    #[inline]
    pub fn neq64(a: Vec256, b: Vec256) -> Vec256Mask64 {
        unsafe { _pext_u32(!_mm256_movemask_epi8(_mm256_cmpeq_epi64(a.raw, b.raw)) as Vec256Mask8, 0x80808080) as Vec256Mask64 }
    }
    ...
    pub fn test8(a: Vec256, b: Vec256) -> Vec256Mask8 {
        Vec256::eq8(a & b, Vec256::zero())
    }

    #[inline]
    pub fn test16(a: Vec256, b: Vec256) -> Vec256Mask16 {
        Vec256::eq16(a & b, Vec256::zero())
    }

    #[inline]
    pub fn test32(a: Vec256, b: Vec256) -> Vec256Mask32 {
        Vec256::eq32(a & b, Vec256::zero())
    }

    #[inline]
    pub fn test64(a: Vec256, b: Vec256) -> Vec256Mask64 {
        Vec256::eq64(a & b, Vec256::zero())
    }
    ...
    pub fn testn8(a: Vec256, b: Vec256) -> Vec256Mask8 {
        Vec256::neq8(a & b, Vec256::zero())
    }

    #[inline]
    pub fn testn16(a: Vec256, b: Vec256) -> Vec256Mask16 {
        Vec256::neq16(a & b, Vec256::zero())
    }

    #[inline]
    pub fn testn32(a: Vec256, b: Vec256) -> Vec256Mask32 {
        Vec256::neq32(a & b, Vec256::zero())
    }

    #[inline]
    pub fn testn64(a: Vec256, b: Vec256) -> Vec256Mask64 {
        Vec256::neq64(a & b, Vec256::zero())
    }
    ...
    #[inline]
    fn expand_mask8(mask: Vec256Mask8) -> Vec256 {
        unsafe {
    ...
    #[inline]
    fn expand_mask16(mask: Vec256Mask16) -> Vec256 {
        unsafe {
            ...
            _mm256_cmpeq_epi16(and_mask, _mm256_and_si256(and_mask, _mm256_set1_epi16(mask as i16))).into()
        }
    }

    #[inline]
    fn expand_mask32(mask: Vec256Mask32) -> Vec256 {
        unsafe {
            let and_mask = _mm256_setr_epi32(
                0x01, 0x02, 0x04, 0x08,
                0x10, 0x20, 0x40, 0x80
            );

            _mm256_cmpeq_epi32(and_mask, _mm256_and_si256(and_mask, _mm256_set1_epi8(mask as i8))).into()
        }
    }
}
...
impl Vec512 {
    ...
    pub unsafe fn store<T>(dst: *mut T, src: Vec512) {
        unsafe {
            Vec256::store(dst, src.inner[0]);
            Vec256::store(dst.byte_add(32), src.inner[1]);
        }
    }
    ...
    pub fn into_u32(self) -> u32 {
        self.inner[0].into_u32()
    }

    #[inline]
    pub fn into_vec128(self) -> Vec128 {
        self.inner[0].into_vec128()
    }
    ...
    pub fn add8(a: Vec512, b: Vec512) -> Vec512 {
        Vec512::from([Vec256::add8(a.inner[0], b.inner[0]), Vec256::add8(a.inner[1], b.inner[1])])
    }

    #[inline]
    pub fn add16(a: Vec512, b: Vec512) -> Vec512 {
        Vec512::from([Vec256::add16(a.inner[0], b.inner[0]), Vec256::add16(a.inner[1], b.inner[1])])
    }

    #[inline]
    pub fn add32(a: Vec512, b: Vec512) -> Vec512 {
        Vec512::from([Vec256::add32(a.inner[0], b.inner[0]), Vec256::add32(a.inner[1], b.inner[1])])
    }
    ...
    pub fn sub8(a: Vec512, b: Vec512) -> Vec512 {
        Vec512::from([Vec256::sub8(a.inner[0], b.inner[0]), Vec256::sub8(a.inner[1], b.inner[1])])
    }

    #[inline]
    pub fn sub16(a: Vec512, b: Vec512) -> Vec512 {
        Vec512::from([Vec256::sub16(a.inner[0], b.inner[0]), Vec256::sub16(a.inner[1], b.inner[1])])
    }

    #[inline]
    pub fn sub32(a: Vec512, b: Vec512) -> Vec512 {
        Vec512::from([Vec256::sub32(a.inner[0], b.inner[0]), Vec256::sub32(a.inner[1], b.inner[1])])
    }
    ...
    pub fn shl16<const SHIFT: i32>(vec: Vec512) -> Vec512 {
        Vec512::from([Vec256::shl16::<SHIFT>(vec.inner[0]), Vec256::shl16::<SHIFT>(vec.inner[1])])
    }

    #[inline]
    pub fn shlv16(vec: Vec512, shift: Vec512) -> Vec512 {
        Vec512::from([Vec256::shlv16(vec.inner[0], shift.inner[0]), Vec256::shlv16(vec.inner[1], shift.inner[1])])
    }
    ...
    pub fn shl64<const SHIFT: i32>(vec: Vec512) -> Vec512 {
        Vec512::from([Vec256::shl64::<SHIFT>(vec.inner[0]), Vec256::shl64::<SHIFT>(vec.inner[1])])
    }

    #[inline]
    pub fn shr16<const SHIFT: i32>(vec: Vec512) -> Vec512 {
        Vec512::from([Vec256::shr16::<SHIFT>(vec.inner[0]), Vec256::shr16::<SHIFT>(vec.inner[1])])
    }

    #[inline]
    pub fn shrv16(vec: Vec512, shift: Vec512) -> Vec512 {
        Vec512::from([Vec256::shrv16(vec.inner[0], shift.inner[0]), Vec256::shrv16(vec.inner[1], shift.inner[1])])
    }

    #[inline]
    pub fn shrv16_mz(mask: Vec512Mask16, vec: Vec512, shift: Vec512) -> Vec512 {
        Vec512::mask16(mask, Vec512::shrv16(vec, shift))
    }

    #[inline]
    pub fn shr64<const SHIFT: i32>(vec: Vec512) -> Vec512 {
        Vec512::from([Vec256::shr64::<SHIFT>(vec.inner[0]), Vec256::shr64::<SHIFT>(vec.inner[1])])
    }
    ...
    #[inline]
    pub fn compress16(mut mask: Vec512Mask16, vec: Vec512) -> Vec512 {
        let mut values = [0u16; Self::CHUNKS_16];
        unsafe { Vec512::store(values.as_mut_ptr(), vec); }
    ...
    #[inline]
    pub fn compress32(mut mask: Vec512Mask32, vec: Vec512) -> Vec512 {
        let mut values = [0u32; Self::CHUNKS_32];
        unsafe { Vec512::store(values.as_mut_ptr(), vec); }
    ...
    #[inline]
    pub fn compress64(mut mask: Vec512Mask64, vec: Vec512) -> Vec512 {
        let mut values = [0u64; Self::CHUNKS_64];
        unsafe { Vec512::store(values.as_mut_ptr(), vec); }
    ...
    #[inline]
    pub fn compress_store8<T>(dest: *mut T, mut mask: Vec512Mask8, vec: Vec512) {
        let mut values = [0u8; Self::CHUNKS_8];
        unsafe { Vec512::store(values.as_mut_ptr(), vec); }
    ...
    #[inline]
    pub fn compress_store32<T>(dest: *mut T, mut mask: Vec512Mask32, vec: Vec512) {
        let mut values = [0u32; Self::CHUNKS_32];
        unsafe { Vec512::store(values.as_mut_ptr(), vec); }
    ...
    pub fn blend8(mask: Vec512Mask8, a: Vec512, b: Vec512) -> Vec512 {
        ...
        Vec512::from([
            Vec256::blend8(mask.inner[0],a.inner[0], b.inner[0]),
            Vec256::blend8(mask.inner[1], a.inner[1], b.inner[1])
        ])
    }
    
    #[inline]
    pub fn permute8(index: Vec512, vec: Vec512) -> Vec512 {
        let mask_lo = Vec256::shl16::<2>(index.inner[0]);
        let mask_hi = Vec256::shl16::<2>(index.inner[1]);

        let lo = Vec256::blend8(
            mask_lo,
            Vec256::permute8(vec.inner[0], index.inner[0]),
            Vec256::permute8(vec.inner[1], index.inner[0]),
        );
        let hi = Vec256::blend8(
            mask_hi,
            Vec256::permute8(vec.inner[0], index.inner[1]),
            Vec256::permute8(vec.inner[1], index.inner[1]),
        );
    ...
    pub fn permute8_128(index: Vec512, vec: Vec128) -> Vec512 {
        ...
        let lo = Vec256::shuffle8(vec, index.inner[0]);
        let hi = Vec256::shuffle8(vec, index.inner[1]);
    ...
    pub fn bitshuffle(a: Vec512, b: Vec512) -> Vec512Mask8 {
        Vec256::bitshuffle(a.inner[0], b.inner[0]) as Vec512Mask8 | ((Vec256::bitshuffle(b.inner[1], b.inner[1]) as Vec512Mask8) << 32)
    }
    ...
    pub fn lane_splat8to64(vec: Vec512) -> Vec512 {
        Vec512::from([Vec256::lane_splat8to64(vec.inner[0]), Vec256::lane_splat8to64(vec.inner[1])])
    }
    ...
    pub fn msb8(self) -> Vec512Mask8 {
        interleave64(self.inner[0].msb8(), self.inner[1].msb8())
    }
    ...
    #[inline]
    pub fn zero32(self) -> Vec512Mask32 {
        Vec512::eq32(self, Vec512::zero())
    }

    #[inline]
    pub fn zero64(self) -> Vec512Mask64 {
        Vec512::eq64(self, Vec512::zero())
    }
    ...
    pub fn eq8(a: Vec512, b: Vec512) -> Vec512Mask8 {
        interleave64(
            Vec256::eq8(a.inner[0], b.inner[0]),
            Vec256::eq8(a.inner[1], b.inner[1])
        )
    }
    ...
    pub fn eq16(a: Vec512, b: Vec512) -> Vec512Mask16 {
        let x = interleave64(
            unsafe { _mm256_movemask_epi8(_mm256_cmpeq_epi16(a.inner[0].raw, b.inner[0].raw)) as Vec256Mask8 },
            unsafe { _mm256_movemask_epi8(_mm256_cmpeq_epi16(a.inner[1].raw, b.inner[1].raw)) as Vec256Mask8 },
        );
    ...
    #[inline]
    pub fn eq32(a: Vec512, b: Vec512) -> Vec512Mask32 {
        let x = interleave64(
            unsafe { _mm256_movemask_epi8(_mm256_cmpeq_epi32(a.inner[0].raw, b.inner[0].raw)) as Vec256Mask8 },
            unsafe { _mm256_movemask_epi8(_mm256_cmpeq_epi32(a.inner[1].raw, b.inner[1].raw)) as Vec256Mask8 },
        );

        unsafe { _pext_u64(x, 0x8888888888888888) as Vec512Mask32 }
    }

    #[inline]
    pub fn eq64(a: Vec512, b: Vec512) -> Vec512Mask64 {
        let x = interleave64(
            unsafe { _mm256_movemask_epi8(_mm256_cmpeq_epi64(a.inner[0].raw, b.inner[0].raw)) as Vec256Mask8 },
            unsafe { _mm256_movemask_epi8(_mm256_cmpeq_epi64(a.inner[1].raw, b.inner[1].raw)) as Vec256Mask8 },
        );
    ...
    pub fn neq8(a: Vec512, b: Vec512) -> Vec512Mask8 {
        interleave64(
            Vec256::neq8(a.inner[0], b.inner[0]),
            Vec256::neq8(a.inner[1], b.inner[1])
        )
    }
    ...
    #[inline]
    pub fn neq32(a: Vec512, b: Vec512) -> Vec512Mask32 {
        let x = interleave64(
            unsafe { _mm256_movemask_epi8(_mm256_cmpeq_epi32(a.inner[0].raw, b.inner[0].raw)) as Vec256Mask8 },
            unsafe { _mm256_movemask_epi8(_mm256_cmpeq_epi32(a.inner[1].raw, b.inner[1].raw)) as Vec256Mask8 },
        );
    ...
    pub fn test16(a: Vec512, b: Vec512) -> Vec512Mask16 {
        Vec512::eq16(a & b, Vec512::zero())
    }

    #[inline]
    pub fn test32(a: Vec512, b: Vec512) -> Vec512Mask32 {
        Vec512::eq32(a & b, Vec512::zero())
    }

    #[inline]
    pub fn test64(a: Vec512, b: Vec512) -> Vec512Mask64 {
        Vec512::eq64(a & b, Vec512::zero())
    }
    ...
    #[inline]
    pub fn testn32(a: Vec512, b: Vec512) -> Vec512Mask32 {
        Vec512::neq32(a & b, Vec512::zero())
    }

    #[inline]
    pub fn testn64(a: Vec512, b: Vec512) -> Vec512Mask64 {
        Vec512::neq64(a & b, Vec512::zero())
    }
    ...
    #[inline]
    pub fn expand_mask32(mut mask: Vec512Mask32) -> Vec512 {
        let mut temp = [0u32; Self::CHUNKS_32];
    ...
    #[inline]
    pub fn expand_mask64(mut mask: Vec512Mask64) -> Vec512 {
        let mut temp = [0u64; Self::CHUNKS_64];
...
impl From<Vec128> for Vec512 {
    ...
    fn from(vec: Vec128) -> Vec512 {
        Vec512 { inner: [ Vec256::from(vec), Vec256::zero() ] }
    }
}
    ...
    fn from(arr: [u8; 64]) -> Self {
        Vec512 {
            inner: [
                ...
                unsafe { Vec256::load(arr.as_ptr().add(32)) }
            ]
        }
    }
}
...
impl From<[u16; 32]> for Vec512 {
    ...
    fn from(arr: [u16; 32]) -> Self {
        Vec512 {
            inner: [
                unsafe { Vec256::load(arr.as_ptr()) },
                unsafe { Vec256::load(arr.as_ptr().add(16)) },
            ]
        }
    }
}
...
impl From<[u32; 16]> for Vec512 {
    ...
    fn from(arr: [u32; 16]) -> Self {
        Vec512 {
            inner: [
                unsafe { Vec256::load(arr.as_ptr()) },
                unsafe { Vec256::load(arr.as_ptr().add(8)) },
            ]
        }
    }
}
...
impl From<[u64; 8]> for Vec512 {
    ...
    fn from(arr: [u64; 8]) -> Self {
        Vec512 {
            inner: [
                unsafe { Vec256::load(arr.as_ptr()) },
                unsafe { Vec256::load(arr.as_ptr().add(4)) },
            ]
        }
    }
}
    ...
    ($($trait:ident, $fn:ident;)*) => {$(
        impl $trait for Vec512 {
            ...
            fn $fn(self, other: Vec512) -> Vec512 {
                Vec512::from([
                    self.inner[0].$fn(other.inner[0]),
                    self.inner[1].$fn(other.inner[1]),
                ])
            }
        }
    )*}
